...
<div class="wrap center">
    <div class="card">
        <div class="card-body">
            ...
            <div class="header" style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                ...
                <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
                    <button type="button"
                            ...
                            onclick="window.open('history.php','_blank')">
                        السجل
                    </button>
            ...
            <form id="uploadForm" class="uploader" action="upload.php" method="post" enctype="multipart/form-data">
                <div class="file">
        ...
        <div class="footer">
            <div>سيتم حفظ النتائج داخل <b>outputs</b></div>
            <div>© <?= date('Y') ?> • <a class="link" href="index.php">إعادة التعيين</a> • <a class="link" href="history.php">السجل</a></div>
        </div>
    </div>
</div>
